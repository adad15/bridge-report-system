...
Json::Value BridgeDeletionCounts::to_json() const {
    ...
    value["report_settings"] = report_settings;
    value["report_personnel_assignments"] = report_personnel_assignments;
    value["report_equipment_assignments"] = report_equipment_assignments;
    value["report_generation_jobs"] = report_generation_jobs;
    value["running_report_generation_jobs"] = running_report_generation_jobs;
    value["report_comparison_references"] = report_comparison_references;
...
BridgeDeletionCounts& BridgeDeletionCounts::operator+=(const BridgeDeletionCounts& other) {
    ...
    report_personnel_assignments += other.report_personnel_assignments;
    report_equipment_assignments += other.report_equipment_assignments;
    report_generation_jobs += other.report_generation_jobs;
    running_report_generation_jobs += other.running_report_generation_jobs;
    report_comparison_references += other.report_comparison_references;
