      ...
      <tr className="defect-card-row">
        <td>
          ...
          <div className="defect-fact-grid">
            ...
            <input id={reviewTargetId("defect-field", defect.candidate_id, "photo_numbers")} aria-label="照片编号" disabled={disabled} value={defect.photo_numbers.join(", ")} onClick={keepRowOpen} onChange={(event) => dispatch({ type: "edit_defect_field", candidateId: defect.candidate_id, field: "photo_numbers", value: parsePhotoNumbers(event.target.value) })} />
