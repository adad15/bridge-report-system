...
export function data(): BridgeAnnualInspectionData {
  return {
    contract: { name: "BridgeAnnualInspectionData", version: "5.0", generated_at: "2026-07-12", producer: "test", parser_name: "test", parser_version: "4" },
